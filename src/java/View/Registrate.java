...
"                        <input class=\"txtInput\" type=\"text\" name=\"nombre\" id=\"nombre\"/>\n" +
"                    </div>\n" +
"                    <div class=\"formControl\">\n" +
"                        <div class=\"lb\">Edad:</div>\n" +
"                        <input class=\"txtInput\" type=\"text\" name=\"edad\" id=\"edad\"/>\n" +
"                    </div>\n" +
"                    <div class=\"formControl\">\n" +
"                        <div class=\"lb\">Sexo:</div>\n" +
"                        <input class=\"txtInput\" type=\"text\" name=\"sexo\" id=\"sexo\"/>\n" +
"                    </div>\n" +
"                    <div class=\"formControl\">\n" +
"                        <div class=\"lb\">Estatura:</div>\n" +
"                        <input class=\"txtInput\" type=\"text\" name=\"estatura\" id=\"estatura\"/>\n" +
"                    </div>\n" +
"                    <div class=\"formControl\">\n" +
...
"                    </div>\n" +
"                    <div class=\"formControl\">\n" +
"                        <div class=\"lb\">Contraseña:</div>\n" +
"                        <input class=\"txtInput\" type=\"password\" name=\"contrasena\" id=\"contrasena\"/>\n" +
"                    </div>\n" +
"                    <div class=\"formControl\">\n" +
"                        <div class=\"lb\">Repitela:</div>\n" +
"                        <input class=\"txtInput\" type=\"password\" name=\"repContrasena\" id=\"repContrasena\"/>\n" +
"                    </div>\n" +
"                    <div class=\"btnContent2\">\n" +
"                        <button class=\"btn2\" type=\"sudmit\">Registrate</button>\n" +
"                    </div>\n" +
"                </form>\n" +
"            </div>\n" +
"        </div>");
