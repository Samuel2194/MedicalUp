...
"                        <button class=\"btn2\" type=\"button\" onclick=\"location.href ='AdministrarUsuario'\">Administrar Usuario</button>\n" +
"                    </div>"
                    + "<div class=\"btnContent2\">\n" +
"                        <button class=\"btn2\" type=\"button\" onclick=\"location.href ='VerIMC'\">Ver mi IMC</button>\n" +
"                    </div>");
            out.println("</body>");
            out.println("</html>");
        }
